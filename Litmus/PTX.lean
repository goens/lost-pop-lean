...
deflitmus WRC_acqrel := {| W. sys_rlx x=1 || R. sys_acq x // 1; W. sys_rel y = 1 || R. sys_acq y // 1 ; R. sys_acq x // 0|} 𐄂
   Trace Hint := [Accept (R. sys_acq y) at Thread 2, Accept (R. sys_acq x) at Thread 1, Accept (W. sys_rel y = 1) at Thread 1, Accept (W x = 1) at Thread 0, Propagate Request 2 to Thread 0, Propagate Request 3 to Thread 2, Propagate Request 4 to Thread 2, Propagate Request 2 to Thread 1, Propagate Request 5 to Thread 1, Propagate Request 3 to Thread 0, Propagate Request 4 to Thread 0, Accept (R. sys_acq x) at Thread 2, Satisfy Request 2 with Request 4, Propagate Request 6 to Thread 0, Propagate Request 5 to Thread 2, Satisfy Request 3 with Request 5, Propagate Request 6 to Thread 1, Satisfy Request 6 with Request 0]
...
deflitmus WRC_cta_2_1' := {| W. cta_rlx x=1 || R. cta_rlx x // 1; Fence. sys_rel; W. sys_rlx y = 1 || R. sys_rlx y // 1 ; Fence. sys_acq; R. sys_rlx x // 0 |}
  where sys := { {T0, T1}, {T2}} 𐄂
    Trace Hint := [Accept (R y) at Thread 2, Accept (Fence. sys_acq) at Thread 2, Accept (R. cta_rlx x) at Thread 1, Accept (Fence. sys_rel) at Thread 1, Accept (W y = 1) at Thread 1, Accept (W. cta_rlx x = 1) at Thread 0, Propagate Request 2 to Thread 0, Propagate Request 3 to Thread 0, Propagate Request 4 to Thread 0, Propagate Request 4 to Thread 2, Propagate Request 5 to Thread 0, Propagate Request 5 to Thread 2, Propagate Request 6 to Thread 0, Propagate Request 6 to Thread 2, Propagate Request 2 to Thread 1, Accept (R x) at Thread 2, Satisfy Request 2 with Request 6, Propagate Request 3 to Thread 1, Propagate Request 7 to Thread 1, Propagate Request 7 to Thread 2, Satisfy Request 4 with Request 7, Propagate Request 8 to Thread 0, Propagate Request 8 to Thread 1, Satisfy Request 8 with Request 0]
...
deflitmus MP3 := {| W. cta_rel x=1;  W. cta_rel y=1 || R. cta_acq y // 1; W. cta_rel z = 1 || R. cta_acq z // 1 ; R. cta_acq x // 0|} 𐄂
  Trace Hint := [Accept (R. cta_acq z) at Thread 2, Accept (R. cta_acq x) at Thread 2, Accept (R. cta_acq y) at Thread 1, Accept (W. cta_rel z = 1) at Thread 1, Accept (W. cta_rel x = 1) at Thread 0, Accept (W. cta_rel y = 1) at Thread 0, Propagate Request 3 to Thread 0, Propagate Request 4 to Thread 0, Propagate Request 5 to Thread 2, Propagate Request 6 to Thread 2, Propagate Request 3 to Thread 1, Propagate Request 4 to Thread 1, Propagate Request 7 to Thread 1, Propagate Request 7 to Thread 2, Propagate Request 8 to Thread 1, Propagate Request 5 to Thread 0, Propagate Request 6 to Thread 0, Propagate Request 8 to Thread 2, Satisfy Request 3 with Request 6, Satisfy Request 4 with Request 0, Satisfy Request 5 with Request 8]
...
deflitmus MP3_scoped := {| W. cta_rel x=1;  W. cta_rel y=1 || R. cta_acq y // 1; W. cta_rel z = 1 || R. cta_acq z // 1 ; R. cta_acq x // 0|}
  where sys := { {T0}, {T1, T2}} 𐄂
  Trace Hint := [Accept (R. cta_acq z) at Thread 2, Accept (R. cta_acq y) at Thread 1, Accept (W. cta_rel z = 1) at Thread 1, Accept (W. cta_rel x = 1) at Thread 0, Accept (W. cta_rel y = 1) at Thread 0, Propagate Request 3 to Thread 0, Propagate Request 4 to Thread 2, Propagate Request 5 to Thread 0, Propagate Request 3 to Thread 1, Propagate Request 5 to Thread 2, Accept (R. cta_acq x) at Thread 2, Satisfy Request 3 with Request 5, Propagate Request 6 to Thread 1, Propagate Request 7 to Thread 1, Propagate Request 4 to Thread 0, Propagate Request 7 to Thread 2, Satisfy Request 4 with Request 7, Propagate Request 8 to Thread 0, Propagate Request 6 to Thread 2, Propagate Request 8 to Thread 1, Satisfy Request 8 with Request 0]
