...
static const value_t ru_NUM_REQS __attribute__((unused)) = VALUE_C(6);

static const value_t ru_NUM_THREADS __attribute__((unused)) = VALUE_C(4);

static bool ru_propagate(const char *rule_name __attribute__((unused)), struct state *NONNULL s __attribute__((unused)), struct handle ru_req, struct handle ru_thread) {
  const struct handle ru_propagated __attribute__((unused)) = state_handle(s, 72ull, 48ull);
  const struct handle ru_order_constraints __attribute__((unused)) = state_handle(s, 0ull, 72ull);
  {
  if (handle_read("testiriw.m:26.8-30: ", rule_name, "propagated[req][thread]", s, VALUE_C(0), VALUE_C(1), handle_index("testiriw.m:26.8-30: ", rule_name, "propagated[req][thread]", s, 2ull, VALUE_C(0), VALUE_C(3), handle_index("testiriw.m:26.8-22: ", rule_name, "propagated[req]", s, 8ull, VALUE_C(0), VALUE_C(5), ru_propagated, handle_read("testiriw.m:26.19-21: ", rule_name, "req", s, VALUE_C(0), VALUE_C(5), ru_req)), handle_read("testiriw.m:26.24-29: ", rule_name, "thread", s, VALUE_C(0), VALUE_C(3), ru_thread))) == VALUE_C(0)) {
handle_write("testiriw.m:27.7-37: ", rule_name, "propagated[req][thread]", s, VALUE_C(0), VALUE_C(1), handle_index("testiriw.m:27.7-29: ", rule_name, "propagated[req][thread]", s, 2ull, VALUE_C(0), VALUE_C(3), handle_index("testiriw.m:27.7-21: ", rule_name, "propagated[req]", s, 8ull, VALUE_C(0), VALUE_C(5), ru_propagated, handle_read("testiriw.m:27.18-20: ", rule_name, "req", s, VALUE_C(0), VALUE_C(5), ru_req)), handle_read("testiriw.m:27.23-28: ", rule_name, "thread", s, VALUE_C(0), VALUE_C(3), ru_thread)), VALUE_C(1));
do {
  value_t v __attribute__((unused)) = handle_read("testiriw.m:28.14-16: ", rule_name, "req", s, VALUE_C(0), VALUE_C(5), ru_req);
  if (v == VALUE_C(0)) {
    do {
  value_t v __attribute__((unused)) = handle_read("testiriw.m:30.18-23: ", rule_name, "thread", s, VALUE_C(0), VALUE_C(3), ru_thread);
  if (v == VALUE_C(1)) {
    if ((handle_read("testiriw.m:32.19-41: ", rule_name, "order_constraints[0][1]", s, VALUE_C(0), VALUE_C(1), handle_index("testiriw.m:32.19-41: ", rule_name, "order_constraints[0][1]", s, 2ull, VALUE_C(0), VALUE_C(5), handle_index("testiriw.m:32.19-38: ", rule_name, "order_constraints[0]", s, 12ull, VALUE_C(0), VALUE_C(5), ru_order_constraints, VALUE_C(0)), VALUE_C(1))) == VALUE_C(0)) && (handle_read("testiriw.m:32.55-77: ", rule_name, "order_constraints[1][0]", s, VALUE_C(0), VALUE_C(1), handle_index("testiriw.m:32.55-77: ", rule_name, "order_constraints[1][0]", s, 2ull, VALUE_C(0), VALUE_C(5), handle_index("testiriw.m:32.55-74: ", rule_name, "order_constraints[1]", s, 12ull, VALUE_C(0), VALUE_C(5), ru_order_constraints, VALUE_C(1)), VALUE_C(0))) == VALUE_C(0))) {
handle_write("testiriw.m:33.19-49: ", rule_name, "order_constraints[0][1]", s, VALUE_C(0), VALUE_C(1), handle_index("testiriw.m:33.19-41: ", rule_name, "order_constraints[0][1]", s, 2ull, VALUE_C(0), VALUE_C(5), handle_index("testiriw.m:33.19-38: ", rule_name, "order_constraints[0]", s, 12ull, VALUE_C(0), VALUE_C(5), ru_order_constraints, VALUE_C(0)), VALUE_C(1)), VALUE_C(1));
}
;
  }
  else if (v == VALUE_C(2)) {
    if ((handle_read("testiriw.m:36.19-41: ", rule_name, "order_constraints[0][4]", s, VALUE_C(0), VALUE_C(1), handle_index("testiriw.m:36.19-41: ", rule_name, "order_constraints[0][4]", s, 2ull, VALUE_C(0), VALUE_C(5), handle_index("testiriw.m:36.19-38: ", rule_name, "order_constraints[0]", s, 12ull, VALUE_C(0), VALUE_C(5), ru_order_constraints, VALUE_C(0)), VALUE_C(4))) == VALUE_C(0)) && (handle_read("testiriw.m:36.55-77: ", rule_name, "order_constraints[4][0]", s, VALUE_C(0), VALUE_C(1), handle_index("testiriw.m:36.55-77: ", rule_name, "order_constraints[4][0]", s, 2ull, VALUE_C(0), VALUE_C(5), handle_index("testiriw.m:36.55-74: ", rule_name, "order_constraints[4]", s, 12ull, VALUE_C(0), VALUE_C(5), ru_order_constraints, VALUE_C(4)), VALUE_C(0))) == VALUE_C(0))) {
handle_write("testiriw.m:37.19-49: ", rule_name, "order_constraints[0][4]", s, VALUE_C(0), VALUE_C(1), handle_index("testiriw.m:37.19-41: ", rule_name, "order_constraints[0][4]", s, 2ull, VALUE_C(0), VALUE_C(5), handle_index("testiriw.m:37.19-38: ", rule_name, "order_constraints[0]", s, 12ull, VALUE_C(0), VALUE_C(5), ru_order_constraints, VALUE_C(0)), VALUE_C(4)), VALUE_C(1));
}
;
  }
} while (0);
    ...
    do {
  value_t v __attribute__((unused)) = handle_read("testiriw.m:41.18-23: ", rule_name, "thread", s, VALUE_C(0), VALUE_C(3), ru_thread);
  if (v == VALUE_C(0)) {
    if ((handle_read("testiriw.m:43.19-41: ", rule_name, "order_constraints[0][1]", s, VALUE_C(0), VALUE_C(1), handle_index("testiriw.m:43.19-41: ", rule_name, "order_constraints[0][1]", s, 2ull, VALUE_C(0), VALUE_C(5), handle_index("testiriw.m:43.19-38: ", rule_name, "order_constraints[0]", s, 12ull, VALUE_C(0), VALUE_C(5), ru_order_constraints, VALUE_C(0)), VALUE_C(1))) == VALUE_C(0)) && (handle_read("testiriw.m:43.55-77: ", rule_name, "order_constraints[1][0]", s, VALUE_C(0), VALUE_C(1), handle_index("testiriw.m:43.55-77: ", rule_name, "order_constraints[1][0]", s, 2ull, VALUE_C(0), VALUE_C(5), handle_index("testiriw.m:43.55-74: ", rule_name, "order_constraints[1]", s, 12ull, VALUE_C(0), VALUE_C(5), ru_order_constraints, VALUE_C(1)), VALUE_C(0))) == VALUE_C(0))) {
handle_write("testiriw.m:44.19-49: ", rule_name, "order_constraints[1][0]", s, VALUE_C(0), VALUE_C(1), handle_index("testiriw.m:44.19-41: ", rule_name, "order_constraints[1][0]", s, 2ull, VALUE_C(0), VALUE_C(5), handle_index("testiriw.m:44.19-38: ", rule_name, "order_constraints[1]", s, 12ull, VALUE_C(0), VALUE_C(5), ru_order_constraints, VALUE_C(1)), VALUE_C(0)), VALUE_C(1));
}
;
  }
} while (0);
    ...
    do {
  value_t v __attribute__((unused)) = handle_read("testiriw.m:48.18-23: ", rule_name, "thread", s, VALUE_C(0), VALUE_C(3), ru_thread);
  if (v == VALUE_C(3)) {
    if ((handle_read("testiriw.m:50.19-41: ", rule_name, "order_constraints[2][5]", s, VALUE_C(0), VALUE_C(1), handle_index("testiriw.m:50.19-41: ", rule_name, "order_constraints[2][5]", s, 2ull, VALUE_C(0), VALUE_C(5), handle_index("testiriw.m:50.19-38: ", rule_name, "order_constraints[2]", s, 12ull, VALUE_C(0), VALUE_C(5), ru_order_constraints, VALUE_C(2)), VALUE_C(5))) == VALUE_C(0)) && (handle_read("testiriw.m:50.55-77: ", rule_name, "order_constraints[5][2]", s, VALUE_C(0), VALUE_C(1), handle_index("testiriw.m:50.55-77: ", rule_name, "order_constraints[5][2]", s, 2ull, VALUE_C(0), VALUE_C(5), handle_index("testiriw.m:50.55-74: ", rule_name, "order_constraints[5]", s, 12ull, VALUE_C(0), VALUE_C(5), ru_order_constraints, VALUE_C(5)), VALUE_C(2))) == VALUE_C(0))) {
handle_write("testiriw.m:51.19-49: ", rule_name, "order_constraints[2][5]", s, VALUE_C(0), VALUE_C(1), handle_index("testiriw.m:51.19-41: ", rule_name, "order_constraints[2][5]", s, 2ull, VALUE_C(0), VALUE_C(5), handle_index("testiriw.m:51.19-38: ", rule_name, "order_constraints[2]", s, 12ull, VALUE_C(0), VALUE_C(5), ru_order_constraints, VALUE_C(2)), VALUE_C(5)), VALUE_C(1));
}
;
  }
} while (0);
    ...
    do {
  value_t v __attribute__((unused)) = handle_read("testiriw.m:55.18-23: ", rule_name, "thread", s, VALUE_C(0), VALUE_C(3), ru_thread);
  if (v == VALUE_C(3)) {
    if ((handle_read("testiriw.m:57.19-41: ", rule_name, "order_constraints[3][5]", s, VALUE_C(0), VALUE_C(1), handle_index("testiriw.m:57.19-41: ", rule_name, "order_constraints[3][5]", s, 2ull, VALUE_C(0), VALUE_C(5), handle_index("testiriw.m:57.19-38: ", rule_name, "order_constraints[3]", s, 12ull, VALUE_C(0), VALUE_C(5), ru_order_constraints, VALUE_C(3)), VALUE_C(5))) == VALUE_C(0)) && (handle_read("testiriw.m:57.55-77: ", rule_name, "order_constraints[5][3]", s, VALUE_C(0), VALUE_C(1), handle_index("testiriw.m:57.55-77: ", rule_name, "order_constraints[5][3]", s, 2ull, VALUE_C(0), VALUE_C(5), handle_index("testiriw.m:57.55-74: ", rule_name, "order_constraints[5]", s, 12ull, VALUE_C(0), VALUE_C(5), ru_order_constraints, VALUE_C(5)), VALUE_C(3))) == VALUE_C(0))) {
handle_write("testiriw.m:58.19-49: ", rule_name, "order_constraints[3][5]", s, VALUE_C(0), VALUE_C(1), handle_index("testiriw.m:58.19-41: ", rule_name, "order_constraints[3][5]", s, 2ull, VALUE_C(0), VALUE_C(5), handle_index("testiriw.m:58.19-38: ", rule_name, "order_constraints[3]", s, 12ull, VALUE_C(0), VALUE_C(5), ru_order_constraints, VALUE_C(3)), VALUE_C(5)), VALUE_C(1));
}
;
  }
} while (0);
    ...
    do {
  value_t v __attribute__((unused)) = handle_read("testiriw.m:62.18-23: ", rule_name, "thread", s, VALUE_C(0), VALUE_C(3), ru_thread);
  if (v == VALUE_C(0)) {
    if ((handle_read("testiriw.m:64.19-41: ", rule_name, "order_constraints[0][4]", s, VALUE_C(0), VALUE_C(1), handle_index("testiriw.m:64.19-41: ", rule_name, "order_constraints[0][4]", s, 2ull, VALUE_C(0), VALUE_C(5), handle_index("testiriw.m:64.19-38: ", rule_name, "order_constraints[0]", s, 12ull, VALUE_C(0), VALUE_C(5), ru_order_constraints, VALUE_C(0)), VALUE_C(4))) == VALUE_C(0)) && (handle_read("testiriw.m:64.55-77: ", rule_name, "order_constraints[4][0]", s, VALUE_C(0), VALUE_C(1), handle_index("testiriw.m:64.55-77: ", rule_name, "order_constraints[4][0]", s, 2ull, VALUE_C(0), VALUE_C(5), handle_index("testiriw.m:64.55-74: ", rule_name, "order_constraints[4]", s, 12ull, VALUE_C(0), VALUE_C(5), ru_order_constraints, VALUE_C(4)), VALUE_C(0))) == VALUE_C(0))) {
handle_write("testiriw.m:65.19-49: ", rule_name, "order_constraints[4][0]", s, VALUE_C(0), VALUE_C(1), handle_index("testiriw.m:65.19-41: ", rule_name, "order_constraints[4][0]", s, 2ull, VALUE_C(0), VALUE_C(5), handle_index("testiriw.m:65.19-38: ", rule_name, "order_constraints[4]", s, 12ull, VALUE_C(0), VALUE_C(5), ru_order_constraints, VALUE_C(4)), VALUE_C(0)), VALUE_C(1));
}
;
  }
} while (0);
    ...
    do {
  value_t v __attribute__((unused)) = handle_read("testiriw.m:69.18-23: ", rule_name, "thread", s, VALUE_C(0), VALUE_C(3), ru_thread);
  if (v == VALUE_C(1)) {
    if ((handle_read("testiriw.m:71.19-41: ", rule_name, "order_constraints[5][2]", s, VALUE_C(0), VALUE_C(1), handle_index("testiriw.m:71.19-41: ", rule_name, "order_constraints[5][2]", s, 2ull, VALUE_C(0), VALUE_C(5), handle_index("testiriw.m:71.19-38: ", rule_name, "order_constraints[5]", s, 12ull, VALUE_C(0), VALUE_C(5), ru_order_constraints, VALUE_C(5)), VALUE_C(2))) == VALUE_C(0)) && (handle_read("testiriw.m:71.55-77: ", rule_name, "order_constraints[2][5]", s, VALUE_C(0), VALUE_C(1), handle_index("testiriw.m:71.55-77: ", rule_name, "order_constraints[2][5]", s, 2ull, VALUE_C(0), VALUE_C(5), handle_index("testiriw.m:71.55-74: ", rule_name, "order_constraints[2]", s, 12ull, VALUE_C(0), VALUE_C(5), ru_order_constraints, VALUE_C(2)), VALUE_C(5))) == VALUE_C(0))) {
handle_write("testiriw.m:72.19-49: ", rule_name, "order_constraints[5][2]", s, VALUE_C(0), VALUE_C(1), handle_index("testiriw.m:72.19-41: ", rule_name, "order_constraints[5][2]", s, 2ull, VALUE_C(0), VALUE_C(5), handle_index("testiriw.m:72.19-38: ", rule_name, "order_constraints[5]", s, 12ull, VALUE_C(0), VALUE_C(5), ru_order_constraints, VALUE_C(5)), VALUE_C(2)), VALUE_C(1));
}
;
  }
  else if (v == VALUE_C(2)) {
    if ((handle_read("testiriw.m:75.19-41: ", rule_name, "order_constraints[5][3]", s, VALUE_C(0), VALUE_C(1), handle_index("testiriw.m:75.19-41: ", rule_name, "order_constraints[5][3]", s, 2ull, VALUE_C(0), VALUE_C(5), handle_index("testiriw.m:75.19-38: ", rule_name, "order_constraints[5]", s, 12ull, VALUE_C(0), VALUE_C(5), ru_order_constraints, VALUE_C(5)), VALUE_C(3))) == VALUE_C(0)) && (handle_read("testiriw.m:75.55-77: ", rule_name, "order_constraints[3][5]", s, VALUE_C(0), VALUE_C(1), handle_index("testiriw.m:75.55-77: ", rule_name, "order_constraints[3][5]", s, 2ull, VALUE_C(0), VALUE_C(5), handle_index("testiriw.m:75.55-74: ", rule_name, "order_constraints[3]", s, 12ull, VALUE_C(0), VALUE_C(5), ru_order_constraints, VALUE_C(3)), VALUE_C(5))) == VALUE_C(0))) {
handle_write("testiriw.m:76.19-49: ", rule_name, "order_constraints[5][3]", s, VALUE_C(0), VALUE_C(1), handle_index("testiriw.m:76.19-41: ", rule_name, "order_constraints[5][3]", s, 2ull, VALUE_C(0), VALUE_C(5), handle_index("testiriw.m:76.19-38: ", rule_name, "order_constraints[5]", s, 12ull, VALUE_C(0), VALUE_C(5), ru_order_constraints, VALUE_C(5)), VALUE_C(3)), VALUE_C(1));
}
;
  }
} while (0);
...
static bool ru_reset(const char *rule_name __attribute__((unused)), struct state *NONNULL s __attribute__((unused))) {
  const struct handle ru_propagated __attribute__((unused)) = state_handle(s, 72ull, 48ull);
  const struct handle ru_order_constraints __attribute__((unused)) = state_handle(s, 0ull, 72ull);
  {
  {
  ...
  handle_write("testiriw.m:87.13-37: ", rule_name, "propagated[i][j]", s, VALUE_C(0), VALUE_C(1), handle_index("testiriw.m:87.13-28: ", rule_name, "propagated[i][j]", s, 2ull, VALUE_C(0), VALUE_C(3), handle_index("testiriw.m:87.13-25: ", rule_name, "propagated[i]", s, 8ull, VALUE_C(0), VALUE_C(5), ru_propagated, handle_read("testiriw.m:87.24: ", rule_name, "i", s, VALUE_C(0), VALUE_C(5), ru_i)), handle_read("testiriw.m:87.27: ", rule_name, "j", s, VALUE_C(0), VALUE_C(3), ru_j)), VALUE_C(0));
...
;
  handle_write("testiriw.m:90.5-28: ", rule_name, "propagated[0][0]", s, VALUE_C(0), VALUE_C(1), handle_index("testiriw.m:90.5-20: ", rule_name, "propagated[0][0]", s, 2ull, VALUE_C(0), VALUE_C(3), handle_index("testiriw.m:90.5-17: ", rule_name, "propagated[0]", s, 8ull, VALUE_C(0), VALUE_C(5), ru_propagated, VALUE_C(0)), VALUE_C(0)), VALUE_C(1));
  handle_write("testiriw.m:91.5-28: ", rule_name, "propagated[1][1]", s, VALUE_C(0), VALUE_C(1), handle_index("testiriw.m:91.5-20: ", rule_name, "propagated[1][1]", s, 2ull, VALUE_C(0), VALUE_C(3), handle_index("testiriw.m:91.5-17: ", rule_name, "propagated[1]", s, 8ull, VALUE_C(0), VALUE_C(5), ru_propagated, VALUE_C(1)), VALUE_C(1)), VALUE_C(1));
  handle_write("testiriw.m:92.5-28: ", rule_name, "propagated[2][1]", s, VALUE_C(0), VALUE_C(1), handle_index("testiriw.m:92.5-20: ", rule_name, "propagated[2][1]", s, 2ull, VALUE_C(0), VALUE_C(3), handle_index("testiriw.m:92.5-17: ", rule_name, "propagated[2]", s, 8ull, VALUE_C(0), VALUE_C(5), ru_propagated, VALUE_C(2)), VALUE_C(1)), VALUE_C(1));
  handle_write("testiriw.m:93.5-28: ", rule_name, "propagated[3][2]", s, VALUE_C(0), VALUE_C(1), handle_index("testiriw.m:93.5-20: ", rule_name, "propagated[3][2]", s, 2ull, VALUE_C(0), VALUE_C(3), handle_index("testiriw.m:93.5-17: ", rule_name, "propagated[3]", s, 8ull, VALUE_C(0), VALUE_C(5), ru_propagated, VALUE_C(3)), VALUE_C(2)), VALUE_C(1));
  handle_write("testiriw.m:94.5-28: ", rule_name, "propagated[4][2]", s, VALUE_C(0), VALUE_C(1), handle_index("testiriw.m:94.5-20: ", rule_name, "propagated[4][2]", s, 2ull, VALUE_C(0), VALUE_C(3), handle_index("testiriw.m:94.5-17: ", rule_name, "propagated[4]", s, 8ull, VALUE_C(0), VALUE_C(5), ru_propagated, VALUE_C(4)), VALUE_C(2)), VALUE_C(1));
  handle_write("testiriw.m:95.5-28: ", rule_name, "propagated[5][3]", s, VALUE_C(0), VALUE_C(1), handle_index("testiriw.m:95.5-20: ", rule_name, "propagated[5][3]", s, 2ull, VALUE_C(0), VALUE_C(3), handle_index("testiriw.m:95.5-17: ", rule_name, "propagated[5]", s, 8ull, VALUE_C(0), VALUE_C(5), ru_propagated, VALUE_C(5)), VALUE_C(3)), VALUE_C(1));
  {
  const value_t lb = VALUE_C(0);
  const value_t ub = VALUE_C(5);
  const raw_value_t step = (raw_value_t)(ub >= lb ? 1 : -1);
  ...
  for (raw_value_t _ru1_j = ((raw_value_t)((raw_value_t)(((raw_value_t)lb) + (raw_value_t)1) - (raw_value_t)(VALUE_C(0)))); _ru1_j == ((raw_value_t)((raw_value_t)(((raw_value_t)lb) + (raw_value_t)1) - (raw_value_t)(VALUE_C(0)))) || (lb < ub && ((value_t)(_ru1_j - (raw_value_t)1 + (raw_value_t)(VALUE_C(0)))) <= ub) || (lb > ub && ((value_t)(_ru1_j - (raw_value_t)1 + (raw_value_t)(VALUE_C(0)))) >= ub); _ru1_j += step) {
    ...
    struct handle ru_j = { .base = _ru2_j, .offset = 0, .width = ((size_t)3ull) };
    handle_write_raw(s, ru_j, _ru1_j);
  handle_write("testiriw.m:98.13-44: ", rule_name, "order_constraints[i][j]", s, VALUE_C(0), VALUE_C(1), handle_index("testiriw.m:98.13-35: ", rule_name, "order_constraints[i][j]", s, 2ull, VALUE_C(0), VALUE_C(5), handle_index("testiriw.m:98.13-32: ", rule_name, "order_constraints[i]", s, 12ull, VALUE_C(0), VALUE_C(5), ru_order_constraints, handle_read("testiriw.m:98.31: ", rule_name, "i", s, VALUE_C(0), VALUE_C(5), ru_i)), handle_read("testiriw.m:98.34: ", rule_name, "j", s, VALUE_C(0), VALUE_C(5), ru_j)), VALUE_C(0));
    /* If this iteration runs right up to the type limits, the last
     * increment will overflow and fail to terminate, so we guard
     * against that here.
     */
...
static bool startstate0(struct state *NONNULL s) {
  ...
  const struct handle ru_order_constraints __attribute__((unused)) = state_handle(s, 0ull, 72ull);
  {
    handle_zero(ru_propagated);
    handle_zero(ru_order_constraints);
    ({ ru_reset(rule_name, state_drop_const(s)); });
  }

  return true;
}

static int guard0(const struct state *NONNULL s __attribute__((unused)), struct handle ru_i __attribute__((unused)), struct handle ru_j __attribute__((unused))) {
  static const char *rule_name __attribute__((unused)) = "guard of rule \"propagate_rule\"";
  if (JMP_BUF_NEEDED) {
    if (sigsetjmp(checkpoint, 0)) {
  ...
  const struct handle ru_propagated __attribute__((unused)) = state_handle(s, 72ull, 48ull);
  const struct handle ru_order_constraints __attribute__((unused)) = state_handle(s, 0ull, 72ull);
  return (((((handle_read("testiriw.m:111.9-24: ", rule_name, "propagated[i][j]", s, VALUE_C(0), VALUE_C(1), handle_index("testiriw.m:111.9-24: ", rule_name, "propagated[i][j]", s, 2ull, VALUE_C(0), VALUE_C(3), handle_index("testiriw.m:111.9-21: ", rule_name, "propagated[i]", s, 8ull, VALUE_C(0), VALUE_C(5), ru_propagated, handle_read("testiriw.m:111.20: ", rule_name, "i", s, VALUE_C(0), VALUE_C(5), ru_i)), handle_read("testiriw.m:111.23: ", rule_name, "j", s, VALUE_C(0), VALUE_C(3), ru_j))) == VALUE_C(0)) && ((handle_read("testiriw.m:112.11: ", rule_name, "i", s, VALUE_C(0), VALUE_C(5), ru_i) != VALUE_C(1)) || (!((handle_read("testiriw.m:114.13-28: ", rule_name, "propagated[2][0]", s, VALUE_C(0), VALUE_C(1), handle_index("testiriw.m:114.13-28: ", rule_name, "propagated[2][0]", s, 2ull, VALUE_C(0), VALUE_C(3), handle_index("testiriw.m:114.13-25: ", rule_name, "propagated[2]", s, 8ull, VALUE_C(0), VALUE_C(5), ru_propagated, VALUE_C(2)), VALUE_C(0))) || handle_read("testiriw.m:114.33-48: ", rule_name, "propagated[2][2]", s, VALUE_C(0), VALUE_C(1), handle_index("testiriw.m:114.33-48: ", rule_name, "propagated[2][2]", s, 2ull, VALUE_C(0), VALUE_C(3), handle_index("testiriw.m:114.33-45: ", rule_name, "propagated[2]", s, 8ull, VALUE_C(0), VALUE_C(5), ru_propagated, VALUE_C(2)), VALUE_C(2)))) || handle_read("testiriw.m:114.53-68: ", rule_name, "propagated[2][3]", s, VALUE_C(0), VALUE_C(1), handle_index("testiriw.m:114.53-68: ", rule_name, "propagated[2][3]", s, 2ull, VALUE_C(0), VALUE_C(3), handle_index("testiriw.m:114.53-65: ", rule_name, "propagated[2]", s, 8ull, VALUE_C(0), VALUE_C(5), ru_propagated, VALUE_C(2)), VALUE_C(3))))))) && ((handle_read("testiriw.m:116.11: ", rule_name, "i", s, VALUE_C(0), VALUE_C(5), ru_i) != VALUE_C(2)) || (((((((handle_read("testiriw.m:118.16-31: ", rule_name, "propagated[0][0]", s, VALUE_C(0), VALUE_C(1), handle_index("testiriw.m:118.16-31: ", rule_name, "propagated[0][0]", s, 2ull, VALUE_C(0), VALUE_C(3), handle_index("testiriw.m:118.16-28: ", rule_name, "propagated[0]", s, 8ull, VALUE_C(0), VALUE_C(5), ru_propagated, VALUE_C(0)), VALUE_C(0))) == handle_read("testiriw.m:118.36-51: ", rule_name, "propagated[1][0]", s, VALUE_C(0), VALUE_C(1), handle_index("testiriw.m:118.36-51: ", rule_name, "propagated[1][0]", s, 2ull, VALUE_C(0), VALUE_C(3), handle_index("testiriw.m:118.36-48: ", rule_name, "propagated[1]", s, 8ull, VALUE_C(0), VALUE_C(5), ru_propagated, VALUE_C(1)), VALUE_C(0)))) && (handle_read("testiriw.m:119.15-30: ", rule_name, "propagated[0][1]", s, VALUE_C(0), VALUE_C(1), handle_index("testiriw.m:119.15-30: ", rule_name, "propagated[0][1]", s, 2ull, VALUE_C(0), VALUE_C(3), handle_index("testiriw.m:119.15-27: ", rule_name, "propagated[0]", s, 8ull, VALUE_C(0), VALUE_C(5), ru_propagated, VALUE_C(0)), VALUE_C(1))) == handle_read("testiriw.m:119.35-50: ", rule_name, "propagated[1][1]", s, VALUE_C(0), VALUE_C(1), handle_index("testiriw.m:119.35-50: ", rule_name, "propagated[1][1]", s, 2ull, VALUE_C(0), VALUE_C(3), handle_index("testiriw.m:119.35-47: ", rule_name, "propagated[1]", s, 8ull, VALUE_C(0), VALUE_C(5), ru_propagated, VALUE_C(1)), VALUE_C(1))))) && (handle_read("testiriw.m:120.15-30: ", rule_name, "propagated[0][2]", s, VALUE_C(0), VALUE_C(1), handle_index("testiriw.m:120.15-30: ", rule_name, "propagated[0][2]", s, 2ull, VALUE_C(0), VALUE_C(3), handle_index("testiriw.m:120.15-27: ", rule_name, "propagated[0]", s, 8ull, VALUE_C(0), VALUE_C(5), ru_propagated, VALUE_C(0)), VALUE_C(2))) == handle_read("testiriw.m:120.35-50: ", rule_name, "propagated[1][2]", s, VALUE_C(0), VALUE_C(1), handle_index("testiriw.m:120.35-50: ", rule_name, "propagated[1][2]", s, 2ull, VALUE_C(0), VALUE_C(3), handle_index("testiriw.m:120.35-47: ", rule_name, "propagated[1]", s, 8ull, VALUE_C(0), VALUE_C(5), ru_propagated, VALUE_C(1)), VALUE_C(2))))) && (handle_read("testiriw.m:121.15-30: ", rule_name, "propagated[0][3]", s, VALUE_C(0), VALUE_C(1), handle_index("testiriw.m:121.15-30: ", rule_name, "propagated[0][3]", s, 2ull, VALUE_C(0), VALUE_C(3), handle_index("testiriw.m:121.15-27: ", rule_name, "propagated[0]", s, 8ull, VALUE_C(0), VALUE_C(5), ru_propagated, VALUE_C(0)), VALUE_C(3))) == handle_read("testiriw.m:121.35-50: ", rule_name, "propagated[1][3]", s, VALUE_C(0), VALUE_C(1), handle_index("testiriw.m:121.35-50: ", rule_name, "propagated[1][3]", s, 2ull, VALUE_C(0), VALUE_C(3), handle_index("testiriw.m:121.35-47: ", rule_name, "propagated[1]", s, 8ull, VALUE_C(0), VALUE_C(5), ru_propagated, VALUE_C(1)), VALUE_C(3))))) && (handle_read("testiriw.m:122.15-37: ", rule_name, "order_constraints[0][1]", s, VALUE_C(0), VALUE_C(1), handle_index("testiriw.m:122.15-37: ", rule_name, "order_constraints[0][1]", s, 2ull, VALUE_C(0), VALUE_C(5), handle_index("testiriw.m:122.15-34: ", rule_name, "order_constraints[0]", s, 12ull, VALUE_C(0), VALUE_C(5), ru_order_constraints, VALUE_C(0)), VALUE_C(1))) == VALUE_C(1))) && (((handle_read("testiriw.m:125.16-31: ", rule_name, "propagated[0][0]", s, VALUE_C(0), VALUE_C(1), handle_index("testiriw.m:125.16-31: ", rule_name, "propagated[0][0]", s, 2ull, VALUE_C(0), VALUE_C(3), handle_index("testiriw.m:125.16-28: ", rule_name, "propagated[0]", s, 8ull, VALUE_C(0), VALUE_C(5), ru_propagated, VALUE_C(0)), VALUE_C(0))) && handle_read("testiriw.m:125.36-51: ", rule_name, "propagated[0][1]", s, VALUE_C(0), VALUE_C(1), handle_index("testiriw.m:125.36-51: ", rule_name, "propagated[0][1]", s, 2ull, VALUE_C(0), VALUE_C(3), handle_index("testiriw.m:125.36-48: ", rule_name, "propagated[0]", s, 8ull, VALUE_C(0), VALUE_C(5), ru_propagated, VALUE_C(0)), VALUE_C(1)))) && handle_read("testiriw.m:126.16-31: ", rule_name, "propagated[0][2]", s, VALUE_C(0), VALUE_C(1), handle_index("testiriw.m:126.16-31: ", rule_name, "propagated[0][2]", s, 2ull, VALUE_C(0), VALUE_C(3), handle_index("testiriw.m:126.16-28: ", rule_name, "propagated[0]", s, 8ull, VALUE_C(0), VALUE_C(5), ru_propagated, VALUE_C(0)), VALUE_C(2)))) && handle_read("testiriw.m:126.36-51: ", rule_name, "propagated[0][3]", s, VALUE_C(0), VALUE_C(1), handle_index("testiriw.m:126.36-51: ", rule_name, "propagated[0][3]", s, 2ull, VALUE_C(0), VALUE_C(3), handle_index("testiriw.m:126.36-48: ", rule_name, "propagated[0]", s, 8ull, VALUE_C(0), VALUE_C(5), ru_propagated, VALUE_C(0)), VALUE_C(3))))) || (((((handle_read("testiriw.m:128.15-30: ", rule_name, "propagated[1][0]", s, VALUE_C(0), VALUE_C(1), handle_index("testiriw.m:128.15-30: ", rule_name, "propagated[1][0]", s, 2ull, VALUE_C(0), VALUE_C(3), handle_index("testiriw.m:128.15-27: ", rule_name, "propagated[1]", s, 8ull, VALUE_C(0), VALUE_C(5), ru_propagated, VALUE_C(1)), VALUE_C(0))) == VALUE_C(1)) && (handle_read("testiriw.m:129.15-30: ", rule_name, "propagated[1][1]", s, VALUE_C(0), VALUE_C(1), handle_index("testiriw.m:129.15-30: ", rule_name, "propagated[1][1]", s, 2ull, VALUE_C(0), VALUE_C(3), handle_index("testiriw.m:129.15-27: ", rule_name, "propagated[1]", s, 8ull, VALUE_C(0), VALUE_C(5), ru_propagated, VALUE_C(1)), VALUE_C(1))) == VALUE_C(1))) && (handle_read("testiriw.m:130.15-30: ", rule_name, "propagated[1][2]", s, VALUE_C(0), VALUE_C(1), handle_index("testiriw.m:130.15-30: ", rule_name, "propagated[1][2]", s, 2ull, VALUE_C(0), VALUE_C(3), handle_index("testiriw.m:130.15-27: ", rule_name, "propagated[1]", s, 8ull, VALUE_C(0), VALUE_C(5), ru_propagated, VALUE_C(1)), VALUE_C(2))) == VALUE_C(1))) && (handle_read("testiriw.m:131.15-30: ", rule_name, "propagated[1][3]", s, VALUE_C(0), VALUE_C(1), handle_index("testiriw.m:131.15-30: ", rule_name, "propagated[1][3]", s, 2ull, VALUE_C(0), VALUE_C(3), handle_index("testiriw.m:131.15-27: ", rule_name, "propagated[1]", s, 8ull, VALUE_C(0), VALUE_C(5), ru_propagated, VALUE_C(1)), VALUE_C(3))) == VALUE_C(1))) && (handle_read("testiriw.m:132.15-37: ", rule_name, "order_constraints[1][0]", s, VALUE_C(0), VALUE_C(1), handle_index("testiriw.m:132.15-37: ", rule_name, "order_constraints[1][0]", s, 2ull, VALUE_C(0), VALUE_C(5), handle_index("testiriw.m:132.15-34: ", rule_name, "order_constraints[1]", s, 12ull, VALUE_C(0), VALUE_C(5), ru_order_constraints, VALUE_C(1)), VALUE_C(0))) == VALUE_C(1)))))) && ((handle_read("testiriw.m:135.11: ", rule_name, "i", s, VALUE_C(0), VALUE_C(5), ru_i) != VALUE_C(3)) || (!((handle_read("testiriw.m:137.13-28: ", rule_name, "propagated[4][0]", s, VALUE_C(0), VALUE_C(1), handle_index("testiriw.m:137.13-28: ", rule_name, "propagated[4][0]", s, 2ull, VALUE_C(0), VALUE_C(3), handle_index("testiriw.m:137.13-25: ", rule_name, "propagated[4]", s, 8ull, VALUE_C(0), VALUE_C(5), ru_propagated, VALUE_C(4)), VALUE_C(0))) || handle_read("testiriw.m:137.33-48: ", rule_name, "propagated[4][1]", s, VALUE_C(0), VALUE_C(1), handle_index("testiriw.m:137.33-48: ", rule_name, "propagated[4][1]", s, 2ull, VALUE_C(0), VALUE_C(3), handle_index("testiriw.m:137.33-45: ", rule_name, "propagated[4]", s, 8ull, VALUE_C(0), VALUE_C(5), ru_propagated, VALUE_C(4)), VALUE_C(1)))) || handle_read("testiriw.m:137.53-68: ", rule_name, "propagated[4][3]", s, VALUE_C(0), VALUE_C(1), handle_index("testiriw.m:137.53-68: ", rule_name, "propagated[4][3]", s, 2ull, VALUE_C(0), VALUE_C(3), handle_index("testiriw.m:137.53-65: ", rule_name, "propagated[4]", s, 8ull, VALUE_C(0), VALUE_C(5), ru_propagated, VALUE_C(4)), VALUE_C(3))))))) && ((handle_read("testiriw.m:139.11: ", rule_name, "i", s, VALUE_C(0), VALUE_C(5), ru_i) != VALUE_C(4)) || (((((((handle_read("testiriw.m:141.16-31: ", rule_name, "propagated[5][0]", s, VALUE_C(0), VALUE_C(1), handle_index("testiriw.m:141.16-31: ", rule_name, "propagated[5][0]", s, 2ull, VALUE_C(0), VALUE_C(3), handle_index("testiriw.m:141.16-28: ", rule_name, "propagated[5]", s, 8ull, VALUE_C(0), VALUE_C(5), ru_propagated, VALUE_C(5)), VALUE_C(0))) == handle_read("testiriw.m:141.36-51: ", rule_name, "propagated[3][0]", s, VALUE_C(0), VALUE_C(1), handle_index("testiriw.m:141.36-51: ", rule_name, "propagated[3][0]", s, 2ull, VALUE_C(0), VALUE_C(3), handle_index("testiriw.m:141.36-48: ", rule_name, "propagated[3]", s, 8ull, VALUE_C(0), VALUE_C(5), ru_propagated, VALUE_C(3)), VALUE_C(0)))) && (handle_read("testiriw.m:142.16-31: ", rule_name, "propagated[5][1]", s, VALUE_C(0), VALUE_C(1), handle_index("testiriw.m:142.16-31: ", rule_name, "propagated[5][1]", s, 2ull, VALUE_C(0), VALUE_C(3), handle_index("testiriw.m:142.16-28: ", rule_name, "propagated[5]", s, 8ull, VALUE_C(0), VALUE_C(5), ru_propagated, VALUE_C(5)), VALUE_C(1))) == handle_read("testiriw.m:142.36-51: ", rule_name, "propagated[3][1]", s, VALUE_C(0), VALUE_C(1), handle_index("testiriw.m:142.36-51: ", rule_name, "propagated[3][1]", s, 2ull, VALUE_C(0), VALUE_C(3), handle_index("testiriw.m:142.36-48: ", rule_name, "propagated[3]", s, 8ull, VALUE_C(0), VALUE_C(5), ru_propagated, VALUE_C(3)), VALUE_C(1))))) && (handle_read("testiriw.m:143.16-31: ", rule_name, "propagated[5][2]", s, VALUE_C(0), VALUE_C(1), handle_index("testiriw.m:143.16-31: ", rule_name, "propagated[5][2]", s, 2ull, VALUE_C(0), VALUE_C(3), handle_index("testiriw.m:143.16-28: ", rule_name, "propagated[5]", s, 8ull, VALUE_C(0), VALUE_C(5), ru_propagated, VALUE_C(5)), VALUE_C(2))) == handle_read("testiriw.m:143.36-51: ", rule_name, "propagated[3][2]", s, VALUE_C(0), VALUE_C(1), handle_index("testiriw.m:143.36-51: ", rule_name, "propagated[3][2]", s, 2ull, VALUE_C(0), VALUE_C(3), handle_index("testiriw.m:143.36-48: ", rule_name, "propagated[3]", s, 8ull, VALUE_C(0), VALUE_C(5), ru_propagated, VALUE_C(3)), VALUE_C(2))))) && (handle_read("testiriw.m:144.16-31: ", rule_name, "propagated[5][3]", s, VALUE_C(0), VALUE_C(1), handle_index("testiriw.m:144.16-31: ", rule_name, "propagated[5][3]", s, 2ull, VALUE_C(0), VALUE_C(3), handle_index("testiriw.m:144.16-28: ", rule_name, "propagated[5]", s, 8ull, VALUE_C(0), VALUE_C(5), ru_propagated, VALUE_C(5)), VALUE_C(3))) == handle_read("testiriw.m:144.36-51: ", rule_name, "propagated[3][3]", s, VALUE_C(0), VALUE_C(1), handle_index("testiriw.m:144.36-51: ", rule_name, "propagated[3][3]", s, 2ull, VALUE_C(0), VALUE_C(3), handle_index("testiriw.m:144.36-48: ", rule_name, "propagated[3]", s, 8ull, VALUE_C(0), VALUE_C(5), ru_propagated, VALUE_C(3)), VALUE_C(3))))) && (handle_read("testiriw.m:145.16-38: ", rule_name, "order_constraints[5][3]", s, VALUE_C(0), VALUE_C(1), handle_index("testiriw.m:145.16-38: ", rule_name, "order_constraints[5][3]", s, 2ull, VALUE_C(0), VALUE_C(5), handle_index("testiriw.m:145.16-35: ", rule_name, "order_constraints[5]", s, 12ull, VALUE_C(0), VALUE_C(5), ru_order_constraints, VALUE_C(5)), VALUE_C(3))) == VALUE_C(1))) && (((handle_read("testiriw.m:148.17-32: ", rule_name, "propagated[5][0]", s, VALUE_C(0), VALUE_C(1), handle_index("testiriw.m:148.17-32: ", rule_name, "propagated[5][0]", s, 2ull, VALUE_C(0), VALUE_C(3), handle_index("testiriw.m:148.17-29: ", rule_name, "propagated[5]", s, 8ull, VALUE_C(0), VALUE_C(5), ru_propagated, VALUE_C(5)), VALUE_C(0))) && handle_read("testiriw.m:148.37-52: ", rule_name, "propagated[5][1]", s, VALUE_C(0), VALUE_C(1), handle_index("testiriw.m:148.37-52: ", rule_name, "propagated[5][1]", s, 2ull, VALUE_C(0), VALUE_C(3), handle_index("testiriw.m:148.37-49: ", rule_name, "propagated[5]", s, 8ull, VALUE_C(0), VALUE_C(5), ru_propagated, VALUE_C(5)), VALUE_C(1)))) && handle_read("testiriw.m:149.17-32: ", rule_name, "propagated[5][2]", s, VALUE_C(0), VALUE_C(1), handle_index("testiriw.m:149.17-32: ", rule_name, "propagated[5][2]", s, 2ull, VALUE_C(0), VALUE_C(3), handle_index("testiriw.m:149.17-29: ", rule_name, "propagated[5]", s, 8ull, VALUE_C(0), VALUE_C(5), ru_propagated, VALUE_C(5)), VALUE_C(2)))) && handle_read("testiriw.m:149.37-52: ", rule_name, "propagated[5][3]", s, VALUE_C(0), VALUE_C(1), handle_index("testiriw.m:149.37-52: ", rule_name, "propagated[5][3]", s, 2ull, VALUE_C(0), VALUE_C(3), handle_index("testiriw.m:149.37-49: ", rule_name, "propagated[5]", s, 8ull, VALUE_C(0), VALUE_C(5), ru_propagated, VALUE_C(5)), VALUE_C(3))))) || (((((handle_read("testiriw.m:151.14-29: ", rule_name, "propagated[3][0]", s, VALUE_C(0), VALUE_C(1), handle_index("testiriw.m:151.14-29: ", rule_name, "propagated[3][0]", s, 2ull, VALUE_C(0), VALUE_C(3), handle_index("testiriw.m:151.14-26: ", rule_name, "propagated[3]", s, 8ull, VALUE_C(0), VALUE_C(5), ru_propagated, VALUE_C(3)), VALUE_C(0))) == VALUE_C(1)) && (handle_read("testiriw.m:152.14-29: ", rule_name, "propagated[3][1]", s, VALUE_C(0), VALUE_C(1), handle_index("testiriw.m:152.14-29: ", rule_name, "propagated[3][1]", s, 2ull, VALUE_C(0), VALUE_C(3), handle_index("testiriw.m:152.14-26: ", rule_name, "propagated[3]", s, 8ull, VALUE_C(0), VALUE_C(5), ru_propagated, VALUE_C(3)), VALUE_C(1))) == VALUE_C(1))) && (handle_read("testiriw.m:153.14-29: ", rule_name, "propagated[3][2]", s, VALUE_C(0), VALUE_C(1), handle_index("testiriw.m:153.14-29: ", rule_name, "propagated[3][2]", s, 2ull, VALUE_C(0), VALUE_C(3), handle_index("testiriw.m:153.14-26: ", rule_name, "propagated[3]", s, 8ull, VALUE_C(0), VALUE_C(5), ru_propagated, VALUE_C(3)), VALUE_C(2))) == VALUE_C(1))) && (handle_read("testiriw.m:154.14-29: ", rule_name, "propagated[3][3]", s, VALUE_C(0), VALUE_C(1), handle_index("testiriw.m:154.14-29: ", rule_name, "propagated[3][3]", s, 2ull, VALUE_C(0), VALUE_C(3), handle_index("testiriw.m:154.14-26: ", rule_name, "propagated[3]", s, 8ull, VALUE_C(0), VALUE_C(5), ru_propagated, VALUE_C(3)), VALUE_C(3))) == VALUE_C(1))) && (handle_read("testiriw.m:155.14-36: ", rule_name, "order_constraints[3][5]", s, VALUE_C(0), VALUE_C(1), handle_index("testiriw.m:155.14-36: ", rule_name, "order_constraints[3][5]", s, 2ull, VALUE_C(0), VALUE_C(5), handle_index("testiriw.m:155.14-33: ", rule_name, "order_constraints[3]", s, 12ull, VALUE_C(0), VALUE_C(5), ru_order_constraints, VALUE_C(3)), VALUE_C(5))) == VALUE_C(1)))))) ? 1 : 0;

}

static bool rule0(struct state *NONNULL s, struct handle ru_i, struct handle ru_j) {
  static const char *rule_name __attribute__((unused)) = "rule \"propagate_rule\"";
  if (JMP_BUF_NEEDED) {
    if (sigsetjmp(checkpoint, 0)) {
  ...
  const struct handle ru_order_constraints __attribute__((unused)) = state_handle(s, 0ull, 72ull);
  {
  ({ uint8_t v684_1_[BITS_TO_BYTES(3)] = { 0 }; struct handle v684_1 = { .base = v684_1_, .offset = 0, .width = 3ull }; { raw_value_t v = handle_read_raw(s, ru_j); raw_value_t v2; value_t v3; static const value_t lb = VALUE_C(0); static const value_t ub = VALUE_C(3); if (v != 0 && (SUB(v, 1, &v2) || ADD(v2, VALUE_C(0), &v3) || v3 < lb || v3 > ub)) { error(s, "call to function %s passed an out-of-range value %" PRIRAWVAL " to parameter 2", "propagate", raw_value_to_string(v + VALUE_C(0) - 1)); } handle_write_raw(s, v684_1, v == 0 ? v : ((raw_value_t)(v3 - VALUE_C(0)) + 1)); } ru_propagate(rule_name, state_drop_const(s), ru_i, v684_1); });
  }
...
static int guard1(const struct state *NONNULL s __attribute__((unused))) {
  static const char *rule_name __attribute__((unused)) = "guard of rule \"reset\"";
  if (JMP_BUF_NEEDED) {
    if (sigsetjmp(checkpoint, 0)) {
      /* this guard triggered an error */
      return -1;
...
static bool rule1(struct state *NONNULL s) {
  static const char *rule_name __attribute__((unused)) = "rule \"reset\"";
  if (JMP_BUF_NEEDED) {
    if (sigsetjmp(checkpoint, 0)) {
      /* an error was triggered during this rule */
      return false;
...
static __attribute__((unused)) bool property0(const struct state *NONNULL s) {
  static const char *rule_name __attribute__((unused)) = "property \"forbidden result: x = 1; y = 0 || y = 1; x = 0\"";
  const struct handle ru_propagated __attribute__((unused)) = state_handle(s, 72ull, 48ull);
  const struct handle ru_order_constraints __attribute__((unused)) = state_handle(s, 0ull, 72ull);
  return (!(((handle_read("testiriw.m:168.7-29: ", rule_name, "order_constraints[4][0]", s, VALUE_C(0), VALUE_C(1), handle_index("testiriw.m:168.7-29: ", rule_name, "order_constraints[4][0]", s, 2ull, VALUE_C(0), VALUE_C(5), handle_index("testiriw.m:168.7-26: ", rule_name, "order_constraints[4]", s, 12ull, VALUE_C(0), VALUE_C(5), ru_order_constraints, VALUE_C(4)), VALUE_C(0))) && handle_read("testiriw.m:168.34-56: ", rule_name, "order_constraints[0][1]", s, VALUE_C(0), VALUE_C(1), handle_index("testiriw.m:168.34-56: ", rule_name, "order_constraints[0][1]", s, 2ull, VALUE_C(0), VALUE_C(5), handle_index("testiriw.m:168.34-53: ", rule_name, "order_constraints[0]", s, 12ull, VALUE_C(0), VALUE_C(5), ru_order_constraints, VALUE_C(0)), VALUE_C(1)))) && handle_read("testiriw.m:169.7-29: ", rule_name, "order_constraints[2][5]", s, VALUE_C(0), VALUE_C(1), handle_index("testiriw.m:169.7-29: ", rule_name, "order_constraints[2][5]", s, 2ull, VALUE_C(0), VALUE_C(5), handle_index("testiriw.m:169.7-26: ", rule_name, "order_constraints[2]", s, 12ull, VALUE_C(0), VALUE_C(5), ru_order_constraints, VALUE_C(2)), VALUE_C(5)))) && handle_read("testiriw.m:169.34-56: ", rule_name, "order_constraints[5][3]", s, VALUE_C(0), VALUE_C(1), handle_index("testiriw.m:169.34-56: ", rule_name, "order_constraints[5][3]", s, 2ull, VALUE_C(0), VALUE_C(5), handle_index("testiriw.m:169.34-53: ", rule_name, "order_constraints[5]", s, 12ull, VALUE_C(0), VALUE_C(5), ru_order_constraints, VALUE_C(5)), VALUE_C(3)))));
...
static bool check_invariants(const struct state *NONNULL s __attribute__((unused))) {
  ...
  {
    if (!property0(s)) {
      error(s, "invariant %s failed", "\"forbidden result: x = 1; y = 0 || y = 1; x = 0\"");
    }
  }
  return true;
}
  ...
  for (raw_value_t _ru1_j = ((raw_value_t)((raw_value_t)(((raw_value_t)lb) + (raw_value_t)1) - (raw_value_t)(VALUE_C(0)))); _ru1_j == ((raw_value_t)((raw_value_t)(((raw_value_t)lb) + (raw_value_t)1) - (raw_value_t)(VALUE_C(0)))) || (lb < ub && ((value_t)(_ru1_j - (raw_value_t)1 + (raw_value_t)(VALUE_C(0)))) <= ub) || (lb > ub && ((value_t)(_ru1_j - (raw_value_t)1 + (raw_value_t)(VALUE_C(0)))) >= ub); _ru1_j += step) {
    ...
    handle_write_raw(s, ru_j, _ru1_j);
        do {
          ...
          int g = guard0(n, ru_i, ru_j);
          if (g == -1) {
            /* guard triggered an error */
            state_free(n);
            break;
          } else if (g == 1) {
            if (!rule0(n, ru_i, ru_j)) {
...
{
  for (size_t i1 = 0; i1 < 4ull; ++i1) {
{
  raw_value_t v = handle_read_raw(s, ((struct handle){ .base = ((struct handle){ .base = ru_propagated.base + (ru_propagated.offset + (i0 * ((size_t)8ull))) / CHAR_BIT, .offset = (ru_propagated.offset + (i0 * ((size_t)8ull))) % CHAR_BIT, .width = 8ull }).base + (((struct handle){ .base = ru_propagated.base + (ru_propagated.offset + (i0 * ((size_t)8ull))) / CHAR_BIT, .offset = (ru_propagated.offset + (i0 * ((size_t)8ull))) % CHAR_BIT, .width = 8ull }).offset + (i1 * ((size_t)2ull))) / CHAR_BIT, .offset = (((struct handle){ .base = ru_propagated.base + (ru_propagated.offset + (i0 * ((size_t)8ull))) / CHAR_BIT, .offset = (ru_propagated.offset + (i0 * ((size_t)8ull))) % CHAR_BIT, .width = 8ull }).offset + (i1 * ((size_t)2ull))) % CHAR_BIT, .width = 2ull }));
  raw_value_t v_previous = 0;
  if (previous != NULL) {
    v_previous = handle_read_raw(previous, ((struct handle){ .base = ((struct handle){ .base = ((struct handle){ .base = (uint8_t*)previous->data + (ru_propagated.base - (const uint8_t*)s->data), .offset = ru_propagated.offset, .width = ru_propagated.width }).base + (((struct handle){ .base = (uint8_t*)previous->data + (ru_propagated.base - (const uint8_t*)s->data), .offset = ru_propagated.offset, .width = ru_propagated.width }).offset + (i0 * ((size_t)8ull))) / CHAR_BIT, .offset = (((struct handle){ .base = (uint8_t*)previous->data + (ru_propagated.base - (const uint8_t*)s->data), .offset = ru_propagated.offset, .width = ru_propagated.width }).offset + (i0 * ((size_t)8ull))) % CHAR_BIT, .width = 8ull }).base + (((struct handle){ .base = ((struct handle){ .base = (uint8_t*)previous->data + (ru_propagated.base - (const uint8_t*)s->data), .offset = ru_propagated.offset, .width = ru_propagated.width }).base + (((struct handle){ .base = (uint8_t*)previous->data + (ru_propagated.base - (const uint8_t*)s->data), .offset = ru_propagated.offset, .width = ru_propagated.width }).offset + (i0 * ((size_t)8ull))) / CHAR_BIT, .offset = (((struct handle){ .base = (uint8_t*)previous->data + (ru_propagated.base - (const uint8_t*)s->data), .offset = ru_propagated.offset, .width = ru_propagated.width }).offset + (i0 * ((size_t)8ull))) % CHAR_BIT, .width = 8ull }).offset + (i1 * ((size_t)2ull))) / CHAR_BIT, .offset = (((struct handle){ .base = ((struct handle){ .base = (uint8_t*)previous->data + (ru_propagated.base - (const uint8_t*)s->data), .offset = ru_propagated.offset, .width = ru_propagated.width }).base + (((struct handle){ .base = (uint8_t*)previous->data + (ru_propagated.base - (const uint8_t*)s->data), .offset = ru_propagated.offset, .width = ru_propagated.width }).offset + (i0 * ((size_t)8ull))) / CHAR_BIT, .offset = (((struct handle){ .base = (uint8_t*)previous->data + (ru_propagated.base - (const uint8_t*)s->data), .offset = ru_propagated.offset, .width = ru_propagated.width }).offset + (i0 * ((size_t)8ull))) % CHAR_BIT, .width = 8ull }).offset + (i1 * ((size_t)2ull))) % CHAR_BIT, .width = 2ull }));
  }
  if (previous == NULL || v != v_previous) {
    if (1 && MACHINE_READABLE_OUTPUT) {
      put("<state_component name=\"");
      do { put("propagated"); put("["); put_val((value_t)((raw_value_t)i0 + (raw_value_t)VALUE_C(0))); put("]"); put("["); put_val((value_t)((raw_value_t)i1 + (raw_value_t)VALUE_C(0))); put("]"); } while (0);
      put("\" value=\"");
    } else {
      do { put("propagated"); put("["); put_val((value_t)((raw_value_t)i0 + (raw_value_t)VALUE_C(0))); put("]"); put("["); put_val((value_t)((raw_value_t)i1 + (raw_value_t)VALUE_C(0))); put("]"); } while (0);
      put(":");
...
}
{
  for (size_t i0 = 0; i0 < 6ull; ++i0) {
{
  for (size_t i1 = 0; i1 < 6ull; ++i1) {
{
  raw_value_t v = handle_read_raw(s, ((struct handle){ .base = ((struct handle){ .base = ru_order_constraints.base + (ru_order_constraints.offset + (i0 * ((size_t)12ull))) / CHAR_BIT, .offset = (ru_order_constraints.offset + (i0 * ((size_t)12ull))) % CHAR_BIT, .width = 12ull }).base + (((struct handle){ .base = ru_order_constraints.base + (ru_order_constraints.offset + (i0 * ((size_t)12ull))) / CHAR_BIT, .offset = (ru_order_constraints.offset + (i0 * ((size_t)12ull))) % CHAR_BIT, .width = 12ull }).offset + (i1 * ((size_t)2ull))) / CHAR_BIT, .offset = (((struct handle){ .base = ru_order_constraints.base + (ru_order_constraints.offset + (i0 * ((size_t)12ull))) / CHAR_BIT, .offset = (ru_order_constraints.offset + (i0 * ((size_t)12ull))) % CHAR_BIT, .width = 12ull }).offset + (i1 * ((size_t)2ull))) % CHAR_BIT, .width = 2ull }));
  raw_value_t v_previous = 0;
  if (previous != NULL) {
    v_previous = handle_read_raw(previous, ((struct handle){ .base = ((struct handle){ .base = ((struct handle){ .base = (uint8_t*)previous->data + (ru_order_constraints.base - (const uint8_t*)s->data), .offset = ru_order_constraints.offset, .width = ru_order_constraints.width }).base + (((struct handle){ .base = (uint8_t*)previous->data + (ru_order_constraints.base - (const uint8_t*)s->data), .offset = ru_order_constraints.offset, .width = ru_order_constraints.width }).offset + (i0 * ((size_t)12ull))) / CHAR_BIT, .offset = (((struct handle){ .base = (uint8_t*)previous->data + (ru_order_constraints.base - (const uint8_t*)s->data), .offset = ru_order_constraints.offset, .width = ru_order_constraints.width }).offset + (i0 * ((size_t)12ull))) % CHAR_BIT, .width = 12ull }).base + (((struct handle){ .base = ((struct handle){ .base = (uint8_t*)previous->data + (ru_order_constraints.base - (const uint8_t*)s->data), .offset = ru_order_constraints.offset, .width = ru_order_constraints.width }).base + (((struct handle){ .base = (uint8_t*)previous->data + (ru_order_constraints.base - (const uint8_t*)s->data), .offset = ru_order_constraints.offset, .width = ru_order_constraints.width }).offset + (i0 * ((size_t)12ull))) / CHAR_BIT, .offset = (((struct handle){ .base = (uint8_t*)previous->data + (ru_order_constraints.base - (const uint8_t*)s->data), .offset = ru_order_constraints.offset, .width = ru_order_constraints.width }).offset + (i0 * ((size_t)12ull))) % CHAR_BIT, .width = 12ull }).offset + (i1 * ((size_t)2ull))) / CHAR_BIT, .offset = (((struct handle){ .base = ((struct handle){ .base = (uint8_t*)previous->data + (ru_order_constraints.base - (const uint8_t*)s->data), .offset = ru_order_constraints.offset, .width = ru_order_constraints.width }).base + (((struct handle){ .base = (uint8_t*)previous->data + (ru_order_constraints.base - (const uint8_t*)s->data), .offset = ru_order_constraints.offset, .width = ru_order_constraints.width }).offset + (i0 * ((size_t)12ull))) / CHAR_BIT, .offset = (((struct handle){ .base = (uint8_t*)previous->data + (ru_order_constraints.base - (const uint8_t*)s->data), .offset = ru_order_constraints.offset, .width = ru_order_constraints.width }).offset + (i0 * ((size_t)12ull))) % CHAR_BIT, .width = 12ull }).offset + (i1 * ((size_t)2ull))) % CHAR_BIT, .width = 2ull }));
  }
  if (previous == NULL || v != v_previous) {
    if (1 && MACHINE_READABLE_OUTPUT) {
      put("<state_component name=\"");
      do { put("order_constraints"); put("["); put_val((value_t)((raw_value_t)i0 + (raw_value_t)VALUE_C(0))); put("]"); put("["); put_val((value_t)((raw_value_t)i1 + (raw_value_t)VALUE_C(0))); put("]"); } while (0);
      put("\" value=\"");
    } else {
      do { put("order_constraints"); put("["); put_val((value_t)((raw_value_t)i0 + (raw_value_t)VALUE_C(0))); put("]"); put("["); put_val((value_t)((raw_value_t)i1 + (raw_value_t)VALUE_C(0))); put("]"); } while (0);
      put(":");
    ...
    handle_write_raw(s, ru_i, _ru1_i);
{
  ...
  if (state_rule_taken_get(s) == rule_taken) {
    if (MACHINE_READABLE_OUTPUT) {
      put("<transition>");
      xml_printf("Rule \"propagate_rule\"");
    } else {
      put("Rule \"propagate_rule\"");
    }
    {
      value_t v = (value_t)((rule_taken - 1) / (1 * 4) % 6) + VALUE_C(0);
      if (MACHINE_READABLE_OUTPUT) {
        put("<parameter name=\"");
        xml_printf("i");
        put("\">");
...
static void state_print_field_offsets(void) {
  ...
  put("-byte aligned\n");
  put("	* field propagated is located at state offset 72 bits\n");
  put("	* field order_constraints is located at state offset 0 bits\n");
  put("\n");
}
